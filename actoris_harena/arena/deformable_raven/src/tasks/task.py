...
from arena.deformable_raven.src import utils
...
class Task():
    ...
    def oracle(self, env):
        ...
        def act(obs, info):
            ...
            if (isinstance(self, tasks.names['cable-ring']) or
                ...
                overshoot = 0.0
                params = self.params_no_rots(vertex_pos, target_pos, overshoot)
                act['pose0'] = params['pose0']
                act['pose1'] = params['pose1']
                ...
                if frac_visible <= BEAD_THRESH:
                    ...
                    act['pose0'] = IDENTITY['pose0']
                    act['pose1'] = IDENTITY['pose1']
                    #act['params'] = IDENTITY
                ...
                param = self.params_no_rots(vertex_pos, target_pos, overshoot)
                act['pose0'] = param['pose0']
                act['pose1'] = param['pose1']
                ...
                if self.task_stage == 1:
                    ...
                    param = self.params_no_rots(p0, p1, overshoot=0.0)
                    act['pose0'] = param['pose0']
                    act['pose1'] = param['pose1']
                ...
                if self.task_stage == 1:
                    ...
                    # Get the usual action parameter, without overshooting.
                    params = self.params_no_rots(p0, p1, overshoot=0.0)
                    act['pose0'] = params['pose0']
                    act['pose1'] = params['pose1']
                ...
                act['pose0'] = (p0, rotation)
                act['pose1'] = (p1, rotation)
    ...
    def fill_template(self, template, replace):
        ...
        template = os.path.join(os.environ['DEFORMABLE_RAVEN_ASSETS_DIR'], template)
