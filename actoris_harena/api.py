...
from actoris_harena.arena.builder import ArenaBuilder

from actoris_harena.agent.registration import AGENTS
from actoris_harena.arena.registration import ARENAS

from actoris_harena.utilities.transform.register import DATA_TRANSFORMER
from actoris_harena.utilities.transform.transform import Transform
from actoris_harena.registration.logger import LOGGER
from actoris_harena.utilities.perform_single import perform_single
from actoris_harena import TrainableAgent, Agent, Arena
...
def retrieve_config(agent_name: str, arena_name:str, 
    ...
    if config_dir == None: ## If None load from agent-arena trajecotry
        config_path = os.path.join(os.environ['actoris_harena_PATH'], 'configuration', 'train_and_evaluate', config_path)
...
def build_arena(
    ...
    Args:
        ...
        project_name: The name of the project, used for organizing logs within
            the save directory. Defaults to 'actoris_harena'.
