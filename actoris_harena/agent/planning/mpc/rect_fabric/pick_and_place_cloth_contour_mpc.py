...
from actoris_harena.utilities.verbose import Verbose

import logging

class RectFabricPickPlaceClothContourMPC(MPC_CEM):
    def __init__(self, config):
        ...
        self.no_op = config.no_op

        self.name = 'Rectangular-fabric Cloth-contour MPC'
    ...
    def act(self,  state, env=None):
        ...
        cloth_edge_mask = env.get_cloth_edge_mask(resolution=(128, 128))
        cloth_mask = env.get_cloth_mask(resolution=(128, 128))
        ...
        goal = env.get_goals()[0] if self.goal_condition else None
