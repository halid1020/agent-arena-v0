        ...
        for ph in [1]:
            for pop in [5000]:
                for it in [100]:
                    for th in [0.99] :
                        for clip in [True]:
                            for cloth_mask in ['from_model']:
                                for cth in [0.3, 0.35, 0.4, 0.42, 0.45, 0.47, 0.49]:

                                    save_file = 'cloth_mask_mpc_action_{}_ph_{}_pop_{}_it_{}_flatten_{}_clip_{}_{}_th_{}'.\
                                                                    format(action_bound, ph, pop, it, th, clip, cloth_mask, cth)
                                    ...
                                    policy_params['cloth_mask_threshold'] = cth
