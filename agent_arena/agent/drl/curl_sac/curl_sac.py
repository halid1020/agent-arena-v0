# code is from https://github.com/Xingyu-Lin/softagent/blob/master/curl/curl_sac.py
...
from agent.algorithm.curl_sac.encoder import make_encoder
...
class CurlSacAgent(object):
    ...
    def update(self, replay_buffer, L, step):
        ...
        ### Prepocess obs TODO
        obs = obs/255.0 - 0.5
        next_obs = obs/255.0 - 0.5
        reward = self.args.reward_scale * reward
        ...
        if step % self.cpc_update_freq == 0 and self.encoder_type == 'pixel':
            ...
            ##TODO: preprocess anchor and pos
            obs_anchor = obs_anchor/255.0 - 0.5
            obs_pos = obs_pos/255.0 - 0.5
